...
namespace RetireSimple.NewEngine.New_Engine.Financials.InvestmentVehicles.InvestmentVehicleInfos {
	public class _457bInfo : InvestmentVehicleInfo {
		...
		public _457bInfo(double contributions, double salary, double salaryIncrease, double rate, double employerMatch, double employerMatchCap) {
